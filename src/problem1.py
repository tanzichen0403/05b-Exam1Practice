...
def run_test_problem1a():
    ...
    print_expected_result_of_test([3, 5], expected, test_results,
                                  format_string)
    actual = problem1a(9, 15)
    print_actual_result_of_test(expected, actual, test_results, precision=3)

    # Test 4:
    expected = 1.412  # This is APPROXIMATELY the correct answer.
    print_expected_result_of_test([31, 45], expected, test_results,
                                  format_string)
    actual = problem1a(31, 45)
    print_actual_result_of_test(expected, actual, test_results, precision=3)
